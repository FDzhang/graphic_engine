#ifndef __CVIDEO_BUFFER_CAMERA_SOURCE_RENDER_H__
#define __CVIDEO_BUFFER_CAMERA_SOURCE_RENDER_H__

#include "../ICameraSourceRender.h"
#include "../DataStruct.h"
class CVideoBufferCameraSourceRender: public ICameraSourceRender
{
public:
