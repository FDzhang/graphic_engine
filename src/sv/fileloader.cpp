...
#include <stdarg.h>
#include <fcntl.h>
#include "../XrCore/XrSrc/Platform/XrOS.h"
//#include "../Tutorial03/XrCore/XrSrc/Platform/XrOS.h"
...
printf("start load bmp %s\n", filename);

    /* Try opening the file; use "rb" mode to read this *binary* file. */
    if ((fp = fopen(filename, "rb")) == NULL) {
printf("bmp open failed %s!!\n", filename);
        return (NULL);
}
