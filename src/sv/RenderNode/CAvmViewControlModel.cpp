...
/*	viewIndex,postion_x, postion_y,postion_z,look_x,look_y,look_z,scrollX,scrollY,scrollZ,camPos;*/
	...
	{   {FRONT_3D_VIEW,                     0.0,    -480.0, -3600.0, 0.0, -480.0, 0.0, 180.0, 25.0, 0.0, CameraPosition_Free}, //rear 3d
		...
		{BMW_RIGHT_VIEW,                    0.0,    -480.0, -3600.0, 0.0, -480.0, 0.0,  90.0, 25.0, 0.0, CameraPosition_BMW_Right}, //right 3d
 		{BMW_LEFT_FRONT_VIEW,               0.0,    -480.0, -3600.0, 0.0, -480.0, 0.0, 315.0, 25.0, 0.0, CameraPosition_BMW_Left_Front}, //front left 3d
 		{BMW_RIGHT_FRONT_VIEW,              0.0,    -480.0, -3600.0, 0.0, -480.0, 0.0,  45.0, 25.0, 0.0, CameraPosition_BMW_Right_Front}, //front right 3d
		{BMW_LEFT_REAR_VIEW,                0.0,    -480.0, -3600.0, 0.0, -480.0, 0.0, 225.0, 25.0, 0.0, CameraPosition_BMW_Left_Rear}, //rear left 3d
		{BMW_RIGHT_REAR_VIEW,               0.0,    -480.0, -3600.0, 0.0, -480.0, 0.0, 135.0, 25.0, 0.0, CameraPosition_BMW_Right_Rear}, //rear right 3d
