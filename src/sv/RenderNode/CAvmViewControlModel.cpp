...
int CAvmViewControlModel::InitViewNode()
{
	...
	m_3dViewCameraParams.znear = m_objectViewCameraParams.znear;
	m_3dViewCameraParams.zfar = m_objectViewCameraParams.zfar;
...
/*	3D视角做X方向旋转时角度取值在0~359*/
	...
	{   {FRONT_3D_VIEW,                     0.0,    -448.0, -3800.0, 0.0, -448.0, 0.0, 180.0, 18.0, 0.0, CameraPosition_Free}, //rear 3d
		//{FRONT_3D_VIEW, 0.0, 0.0, 2820.0, 0.0, 0.0, -580.0, 0.0, 25.0, 0.0, CameraPosition_Free},
		{REAR_3D_VIEW,                      0.0,        0.0,    4000.0,     0.0, 0.0, 0.0, 180.0, 25.0, 0.0, CameraPosition_Free},
