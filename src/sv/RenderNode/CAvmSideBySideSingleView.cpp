/*===========================================================================*\
 * FILE: CAvmSideBySideSingleView.cpp
 *===========================================================================
...
CAvmSideBySideSingleView::CAvmSideBySideSingleView():m_leftRightViewCameraParams(0)
{

}
CAvmSideBySideSingleView::~CAvmSideBySideSingleView()
{

}
int CAvmSideBySideSingleView::InitNode(class IXrCore* pXrcore)
{
	...
	CAvmRenderDataBase::GetInstance()->GetSideBySideSingleViewRegion(&leftViewRegion, left_camera_index);
	...
	CAvmRenderDataBase::GetInstance()->GetSideBySideSingleViewRegion(&rightViewRegion, right_camera_index);
	...
	for(int i = eLeftSingle;i<= eRightSingle;i++)
	{
		...
		//Rotate the Images of side views
		if(m_leftRightviewVertex[i - eLeftSingle])
		{
			if(i == eLeftSingle)
			{
				m_leftRightviewVertex[i - eLeftSingle][3] = 1.0;
				m_leftRightviewVertex[i - eLeftSingle][4] = 0.0;

				m_leftRightviewVertex[i - eLeftSingle][10] = 1.0;
				m_leftRightviewVertex[i - eLeftSingle][11] = 1.0;

				m_leftRightviewVertex[i - eLeftSingle][17] = 0.0;
				m_leftRightviewVertex[i - eLeftSingle][18] = 0.0;

				m_leftRightviewVertex[i - eLeftSingle][24] = 0.0;
				m_leftRightviewVertex[i - eLeftSingle][25] = 1.0;

				
			}
  			else if(i == eRightSingle)
			{
				m_leftRightviewVertex[i - eLeftSingle][3] = 0.0;
				m_leftRightviewVertex[i - eLeftSingle][4] = 1.0;

				m_leftRightviewVertex[i - eLeftSingle][10] = 0.0;
				m_leftRightviewVertex[i - eLeftSingle][11] = 0.0;

				m_leftRightviewVertex[i - eLeftSingle][17] = 1.0;
				m_leftRightviewVertex[i - eLeftSingle][18] = 1.0;

				m_leftRightviewVertex[i - eLeftSingle][24] = 1.0;
				m_leftRightviewVertex[i - eLeftSingle][25] = 0.0;

			}
		}
		m_leftRightViewMesh[i - eLeftSingle]->UnLockData();
...
int CAvmSideBySideSingleView::UpdateNode()
{	
...
int CAvmSideBySideSingleView::SetVisibility(unsigned char pVisibilityFlag)
{
...
int CAvmSideBySideSingleView::SetClear(unsigned char pColorFlag, unsigned char pDepthFlag)
{
