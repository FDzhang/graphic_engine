...
int CSVV302PlaybackTab::SetStateBarVal(void *ptr)
{
    ...
    m_buttonStatus[V302_PB_INDEX_STABR_TURNLEFT] = recCanMsg->TurnLeft;
    m_buttonStatus[V302_PB_INDEX_STABR_TURNRIGHT] = recCanMsg->TurnRight;
    m_buttonStatus[V302_PB_INDEX_STABR_ENGINE] = recCanMsg->Engine;
    ...
    sprintf(m_textEditData[V302_PB_GPS_TEXT].textContent[0],"N %03d.%02d'%02d\"  E %03d.%02d'%02d\"",recCanMsg->GpsLng / 10000,(recCanMsg->GpsLng % 10000) / 100,recCanMsg->GpsLng % 100,recCanMsg->GpsLat / 10000,(recCanMsg->GpsLat % 10000) / 100,recCanMsg->GpsLat % 100);
    
    sprintf(m_textEditData[V302_PB_SPEED_TEXT].textContent[0],"%03d",recCanMsg->Speed);
#endif
