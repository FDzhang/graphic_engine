...
CSVDvrPlayImageTab::~CSVDvrPlayImageTab()
{
    for (int i = 0; i < DVR_PLAYBACK_IMAGE_TAB_ELEMEMT_NUM; i++)
    {
        ...
        if (i == DVR_PLAYBACK_IMAGE_TAB_NEXT_PAGE 
            || i == DVR_PLAYBACK_IMAGE_TAB_PRE_PAGE 
            || i == DVR_PLAYBACK_IMAGE_TAB_EMERGENCY_ICON 
            || i == DVR_PLAYBACK_IMAGE_TAB_DELETE_ICON 
            || i == DVR_PLAYBACK_IMAGE_TAB_DC_SWITCH 
            || i == DVR_PLAYBACK_IMAGE_TAB_VIEW_FRONT
            || i == DVR_PLAYBACK_IMAGE_TAB_VIEW_REAR 
            || i == DVR_PLAYBACK_IMAGE_TAB_VIEW_LEFT 
            || i == DVR_PLAYBACK_IMAGE_TAB_VIEW_RIGHT
            || i == DVR_PLAYBACK_IMAGE_TAB_MENU_HIDE_ICON
            || i == DVR_PLAYBACK_IMAGE_TAB_MENU_HIDE_ICON)
        {
