...
int CSVS302PlaybackTab::SetStateBarVal(void *ptr)
{
    ...
    sprintf(m_textEditData[S302_GPS_TEXT].textContent[0],"N %03d.%02d'%02d\"  E %03d.%02d'%02d\"",recCanMsg->GpsLongitude / 10000,(recCanMsg->GpsLongitude % 10000) / 100,recCanMsg->GpsLongitude % 100,recCanMsg->GpsLatitude / 10000,(recCanMsg->GpsLatitude % 10000) / 100,recCanMsg->GpsLatitude % 100);
