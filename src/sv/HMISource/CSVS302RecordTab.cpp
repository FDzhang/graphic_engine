...
int CSVS302RecordTab::SetStateBarVal(void *ptr)
{
    ...
    m_buttonStatus[S302_RECORD_INDEX_STABR_ENGINE] = (recCanMsg->EngineThrottlePosition > 1) ? 0 : recCanMsg->EngineThrottlePosition;
    ...
    sprintf(m_textEditData[S302_REC_GPS_TEXT].textContent[0],"N %03d.%02d'%02d\"  E %03d.%02d'%02d\"",recCanMsg->GpsLongitude / 10000,(recCanMsg->GpsLongitude % 10000) / 100,recCanMsg->GpsLongitude % 100,recCanMsg->GpsLatitude / 10000,(recCanMsg->GpsLatitude % 10000) / 100,recCanMsg->GpsLatitude % 100);
