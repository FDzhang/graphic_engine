...
void SVNodeTestHMI::InitHMI(int window_width, int window_height)
{
	...
	text_vehicledata_speed_value_pos[0] = status_icon_speed_pos[0] + 0.3 * status_icon_speed_width - 15;
	text_vehicledata_speed_value_pos[1] = window_height - 0.80 * status_icon_speed_height;
	text_vehicledata_speed_value_width = 1;
	text_vehicledata_speed_value_fontsize = 45;
	...
	status_icon_background_pos[0] = status_icon_speed_pos[0] + status_icon_speed_width - 10;
	...
	display_cameraframe_icon_width = 0.13 * window_width;
	...
	display_vehicledata_icon_width = 0.12 * window_width;
	display_vehicledata_icon_height = 0.07  * window_height;
	display_vehicledata_icon_pos[0] = window_width - display_vehicledata_icon_width;
	display_vehicledata_icon_pos[1] = display_cameraframe_icon_pos[1] + 22;
	...
	int text_width = 1;
	int text_fontsize = 30;

	text_frame_num_pos[0] = display_cameraframe_background_icon_pos[0];
	text_frame_num_pos[1] = display_cameraframe_background_icon_pos[1] + 25;
	text_frame_num_width = text_width;
	text_frame_num_fontsize = text_fontsize;

	text_frame_drop_pos[0] = text_frame_num_pos[0];
	text_frame_drop_pos[1] = text_frame_num_pos[1] + 40;
	text_frame_drop_width = text_width;
	text_frame_drop_fontsize = text_fontsize;

	text_total_time_pos[0] = text_frame_num_pos[0] + 14;
	text_total_time_pos[1] = text_frame_drop_pos[1] + 40;
	text_total_time_width = text_width;
	text_total_time_fontsize = text_fontsize;
	
	text_avg_time_pos[0] = text_frame_num_pos[0] + 23;
	text_avg_time_pos[1] = text_total_time_pos[1] + 40;
	text_avg_time_width = text_width;
	text_avg_time_fontsize = text_fontsize;

	text_steering_angle_pos[0] = display_vehicledata_background_icon_pos[0] + 26;
	text_steering_angle_pos[1] = display_vehicledata_background_icon_pos[1] + 35;
	text_steering_angle_width = text_width;
	text_steering_angle_fontsize = text_fontsize;

	text_vd_avg_time_pos[0] = text_steering_angle_pos[0] + 36;
	text_vd_avg_time_pos[1] = text_steering_angle_pos[1] + 55;
	text_vd_avg_time_width = text_width;
	text_vd_avg_time_fontsize = text_fontsize;

	text_yaw_rate_pos[0] = text_steering_angle_pos[0] + 36;
	text_yaw_rate_pos[1] = text_vd_avg_time_pos[1] + 55;
	...
	scroll_1_width = status_icon_speed_width * 0.4;
	scroll_1_height = 30;
	...
	int cf_scroll_height = 20;
	scroll_frame_num_pos[0] = display_cameraframe_icon_pos[0];
	scroll_frame_num_pos[1] = window_height - (text_frame_num_pos[1] + text_frame_num_fontsize * 2.0) + 32;
	scroll_frame_num_width = cf_scroll_width;
	scroll_frame_num_height = cf_scroll_height;

	scroll_frame_drop_pos[0] = text_frame_num_pos[0];
	scroll_frame_drop_pos[1] = scroll_frame_num_pos[1] - 40;
	scroll_frame_drop_width = cf_scroll_width;
    scroll_frame_drop_height = cf_scroll_height;
	
	scroll_total_time_pos[0] = text_frame_num_pos[0];
	scroll_total_time_pos[1] = scroll_frame_drop_pos[1] - 40;
	scroll_total_time_width = cf_scroll_width;
	scroll_total_time_height = cf_scroll_height;

	scroll_avg_time_pos[0] = text_frame_num_pos[0];
	scroll_avg_time_pos[1] = scroll_total_time_pos[1] - 40;
	scroll_avg_time_width = cf_scroll_width;
	scroll_avg_time_height = cf_scroll_height;
	...
	scroll_vd_avg_time_pos[1] = scroll_steering_ang_pos[1] - 55;
	...
	scroll_yaw_rate_pos[1] = scroll_vd_avg_time_pos[1] - 55;
...
void SVNodeTestHMI::SetHMIText()
{
	...
	char frame_num[100] = "Frame-Num : 432 / 0";
	char frame_num_value[100] = "432 / 0";
	char frame_drop[100] = "Frame-Drop : -1.80";
	char frame_drop_value[100] = "-1.80";
	char total_time[100] = "Total-Time : 0.70";
	char total_time_value[100] = "0.70";
	char avg_time[100]   = "Avg-Time : 3.00";
	...
	m_text[0].pos[0] = text_frame_num_pos[0];
	m_text[0].pos[1] = text_frame_num_pos[1];
	m_text[0].line_num = 1;
	m_text[0].width = text_frame_num_width;
	m_text[0].font_size = text_frame_num_fontsize;
	...
	sprintf(m_text[0].text_content[0],"%s",frame_num);

	m_text[1].pos[0] = text_frame_drop_pos[0];
	m_text[1].pos[1] = text_frame_drop_pos[1];
	m_text[1].line_num = 1;
	m_text[1].width = text_frame_drop_width;
	m_text[1].font_size = text_frame_drop_fontsize;
	...
	sprintf(m_text[1].text_content[0],"%s",frame_drop);


	m_text[2].pos[0] = text_total_time_pos[0];
	m_text[2].pos[1] = text_total_time_pos[1];
	m_text[2].line_num = 1;
	m_text[2].width = text_total_time_width;
	m_text[2].font_size = text_total_time_fontsize;
	...
	sprintf(m_text[2].text_content[0],"%s",total_time);


	m_text[3].pos[0] = text_avg_time_pos[0];
	m_text[3].pos[1] = text_avg_time_pos[1];
	m_text[3].line_num = 1;
	m_text[3].width = text_avg_time_width;
	m_text[3].font_size = text_avg_time_fontsize;
	...
	sprintf(m_text[3].text_content[0],"%s",avg_time);
...
void SVNodeTestHMI::SetHMIScroll()
{
	 ...
	 m_scroll[3].pos[0] = scroll_frame_num_pos[0];
	 m_scroll[3].pos[1] = scroll_frame_num_pos[1];
	 m_scroll[3].width = scroll_frame_num_width;
	 m_scroll[3].height = scroll_frame_num_height;
	 ...
	 m_scroll[4].pos[0] = scroll_frame_drop_pos[0];
	 m_scroll[4].pos[1] = scroll_frame_drop_pos[1];
	 m_scroll[4].width = scroll_frame_drop_width;
	 m_scroll[4].height = scroll_frame_drop_height;
	 ...
	 m_scroll[5].pos[0] = scroll_total_time_pos[0];
	 m_scroll[5].pos[1] = scroll_total_time_pos[1];
	 m_scroll[5].width = scroll_total_time_width;
	 m_scroll[5].height = scroll_total_time_height;
	 ...
	 m_scroll[6].pos[0] = scroll_avg_time_pos[0];
	 m_scroll[6].pos[1] = scroll_avg_time_pos[1];
	 m_scroll[6].width = scroll_avg_time_width;
	 m_scroll[6].height = scroll_avg_time_height;
	 m_scroll[6].horizon = 1;
	 m_scroll[6].show_flag = 1;
	 m_scroll[6].scroll_rate = 1.0;
	 m_scroll[6].icon_file_name[0]=new char [50]; 
	 m_scroll[6].icon_file_name[1]=new char [50];
	 sprintf(m_scroll[6].icon_file_name[0],"%sscroll_background.dds",XR_RES);
	 sprintf(m_scroll[6].icon_file_name[1],"%sscroll_process.dds",XR_RES);
...
void SVNodeTestHMI::setIconStatus()
{
	...
	if (demo_status == 1 || demo_status == 2)
	{
		m_icon[2].show_icon_num = 0; //ldw
		m_icon[3].show_icon_num = 0; //bsd
		m_icon[4].show_icon_num = 0; //oc
