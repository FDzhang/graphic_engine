...
typedef struct 
{
    ...
    signed int   size[NVHHDDS_MAX_MIPMAPS * NVHHDDS_NUM_CUBEMAP_FACES];
    /** Array of widths of the mipmap levels for the texture or each cubemap face */
    signed int mipwidth[NVHHDDS_MAX_MIPMAPS * NVHHDDS_NUM_CUBEMAP_FACES];
    /** Array of heights of the mipmap levels for the texture or each cubemap face */
    signed int mipheight[NVHHDDS_MAX_MIPMAPS * NVHHDDS_NUM_CUBEMAP_FACES];
} NVHHDDSImage;
...
/** The main DDS file loading function
    ...
    @see NVHHDDSFree()
*/
NVHHDDSImage *NVHHDDSLoad(const char* filename, signed int flipVertical);
...
//signed int NVHHDDSSave(const NVHHDDSImage *image, const char *filename, signed int flagAsFlipped);
...
/** Generates a compressed texture from uncompressed data 
    ...
    @see NVHHDDSAllocData()
*/
NVHHDDSImage *NVCompressToDXT(NVHHDDSImage *srcImage, signed int toFormat, signed int bMakeMIPMaps);
