#ifndef __XR_TEXTLABLE_H__
#define __XR_TEXTLABLE_H__
#include "CXrPanel.h"


class CXrTextLable : public CXrBaseView
{
public:
	CXrTextLable(Int32 cornerSize, class IActionTrigger* action=0, Boolean reserveState=0);
	~CXrTextLable();
	...
	xr_state AddChinese(class IUINode* node ,Int32 targetIndex, InsertFlag flag, Int32 x, Int32 y, Int32 w, Int32 h, Float32 opacity, String texBase, String texHit);
	xr_state SetText(unsigned int text);
