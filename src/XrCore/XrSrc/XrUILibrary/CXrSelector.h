...
public:
	...
	virtual xr_state Add(class IUINode* node ,Int32 targetIndex, InsertFlag flag, Int32 x, Int32 y, Int32 w, Int32 h, Int32 dx, Int32 dy, Float32 opacity, const char* BGTex, const char* FGTex, Int32 row, Int32 colume);
	...
	virtual Void SetItemText(Int32 num, char* text, Int32 size = -1);
