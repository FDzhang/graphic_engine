...
public:
	...
	************************************************************************/
	CXRString(const char* _Ptr, size_t _Count = npos);
	...
	@Description		Constructor
	************************************************************************/
	CXRString(const CXRString& _Right, size_t _Roff = 0, size_t _Count = npos);
	...
	@Description		Constructor
	*************************************************************************/
	CXRString(size_t _Count, const char _Ch);
	...
	*************************************************************************/
	CXRString& append(const char* _Ptr);
	...
	*************************************************************************/
	CXRString& append(const char* _Ptr, size_t _Count);
	...
	@Description		Appends a string
	*************************************************************************/
	CXRString& append(const CXRString& _Str);
	...
	*************************************************************************/
	CXRString& append(const CXRString& _Str, size_t _Off, size_t _Count);
	...
	*************************************************************************/
	CXRString& append(size_t _Count, const char _Ch);

	//template<class InputIterator> CXRString& append(InputIterator _First, InputIterator _Last);
	...
	*************************************************************************/
	CXRString& assign(const char* _Ptr);
	...
	@Description		Assigns the string to the string _Ptr
	*************************************************************************/
	CXRString& assign(const char* _Ptr, size_t _Count);
	...
	*************************************************************************/
	CXRString& assign(const CXRString& _Str);
	...
	*************************************************************************/
	CXRString& assign(const CXRString& _Str, size_t _Off, size_t _Count=npos);
	...
	*************************************************************************/
	CXRString& assign(size_t _Count, char _Ch);

	//template<class InputIterator> CXRString& assign(InputIterator _First, InputIterator _Last);
	...
	*************************************************************************/
	int compare(const CXRString& _Str) const;
	...
	@Description		Compares the string with _Str
	*************************************************************************/
	int compare(size_t _Pos1, size_t _Num1, const CXRString& _Str) const;
	...
	@Description		Compares the string with _Str
	*************************************************************************/
	int compare(size_t _Pos1, size_t _Num1, const CXRString& _Str, size_t _Off, size_t _Count) const;
	...
	*************************************************************************/
	bool operator<(const CXRString & _Str) const;
	...
	*************************************************************************/
	CXRString& erase(size_t _Pos = 0, size_t _Count = npos);
	...
	//size_t find(const CXRString& _Str, size_t _Off = 0) const;
	...
	*************************************************************************/
	size_t find_first_not_of(const CXRString& _Str, size_t _Off = 0) const;
	...
	*************************************************************************/
	size_t find_first_of(const CXRString& _Str, size_t _Off = 0) const;
	...
	*************************************************************************/
	size_t find_last_not_of(const CXRString& _Str, size_t _Off = 0) const;
	...
	*************************************************************************/
	size_t find_last_of(const CXRString& _Str, size_t _Off = 0) const;

	//allocator_type get_allocator( ) const;

	//CXRString& insert(size_t _P0, const char* _Ptr);
	//CXRString& insert(size_t _P0, const char* _Ptr, size_t _Count);
	//CXRString& insert(size_t _P0, const CXRString& _Str);
	//CXRString& insert(size_t _P0, const CXRString& _Str, size_t _Off, size_t _Count);
	//CXRString& insert(size_t _P0, size_t _Count, char _Ch);
	...
	*************************************************************************/
	...
	//CXRString& replace(iterator _First0, iterator _Last0, const char* _Ptr);
	//CXRString& replace(iterator _First0, iterator _Last0, const CXRString& _Str);
	//CXRString& replace(iterator _First0, iterator _Last0, const char* _Ptr, size_t _Num2);
	//CXRString& replace(iterator _First0, iterator _Last0, size_t _Num2, char _Ch);
	//template<class InputIterator> CXRString& replace(iterator _First0, iterator _Last0, InputIterator _First, InputIterator _Last);
	...
	*************************************************************************/
	...
	@Description		Returns the size of the string
	*************************************************************************/
	CXRString substr(size_t _Off = 0, size_t _Count = npos) const;
	...
	*************************************************************************/
	...
	@Description		+= Operator
	*************************************************************************/
	CXRString& operator+=(const char* _Ptr);
	...
	@Description		+= Operator
	*************************************************************************/
	CXRString& operator+=(const CXRString& _Right);
	...
	*************************************************************************/
	...
	@Description		+ Operator
	*************************************************************************/
	friend CXRString operator+ (const CXRString& _Left, const CXRString& _Right);
	...
	@Description		+ Operator
	*************************************************************************/
	friend CXRString operator+ (const CXRString& _Left, const char* _Right);
	...
	*************************************************************************/
	...
	@Description		+ Operator
	*************************************************************************/
	friend CXRString operator+ (const char* _Left, const CXRString& _Right);
